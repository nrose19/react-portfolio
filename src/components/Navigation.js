    ...
    return(
        <>
            <nav className='bg-blue p-1'>
                ...
                >
                    <li >
                        <Link to="/react-portfolio/about-me" className='flex flex-row m-6 items-baseline'>
                        <h1 style={styles.merriweather}>About</h1>
                        <h2>Me</h2>
                        </Link>
                    </li>
                    <li>
                        <Link to="/react-portfolio/portfolio" className='flex flex-row m-6 items-baseline'>
                        <h1 style={styles.merriweather}>My</h1>
                        Portfolio
                        </Link>
                    </li>
                    <li>
                        <Link to="/react-portfolio/contact-me" className='flex flex-row m-6 items-baseline'>
